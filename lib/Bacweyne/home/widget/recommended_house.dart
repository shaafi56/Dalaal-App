  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: ListView.separated(
                  ...
                  Navigator.push(
                      ...
                      MaterialPageRoute(
                          builder: (builder) => DetailPage(
                              house: recomendedbacweyneList[index])));
                },
                child: Container(
                  height: 310,
                  width: 230,
                      ...
                      Container(
                        decoration: BoxDecoration(
                          image: DecorationImage(
                            image: AssetImage(
                                recomendedbacweyneList[index].imageUrl),
                            fit: BoxFit.cover,
                          ),
                        ),
                      ),
                          ...
                          child: Row(
                            ...
                            children: [
                              Column(
                                ...
                                children: [
                                  Text(
                                    recomendedbacweyneList[index].name,
                                    style: TextStyle(
                                      color: Colors.white,
                                  ...
                                  SizedBox(height: 5),
                                  Text(
                                    recomendedbacweyneList[index].address,
                                    style: TextStyle(
                                      color: Colors.white,
                                      fontWeight: FontWeight.bold,
                                      fontSize: 13,
                                  ...
                                  SizedBox(height: 5),
                                  Text(
                                    recomendedbacweyneList[index].SubAdress,
                                    style: TextStyle(
                                      color: Colors.white,
                                      fontWeight: FontWeight.bold,
                                      fontSize: 12,
                                  ...
                                  Text(
                                    recomendedbacweyneList[index].lacag,
                                    style: TextStyle(
                                      color: Colors.white,
                                      fontWeight: FontWeight.bold,
                                      fontSize: 12,
          ...
          itemCount: recomendedbacweyneList.length),
    );
  }
}

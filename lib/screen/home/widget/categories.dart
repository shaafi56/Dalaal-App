import 'package:dalaalapp/Bacweyne/home/home.dart';
...
class _CategoriesState extends State<Categories> {
  final categoriesList = ['Guri Appartment ah', 'Guri Bacweyne ah', 'Guri Villa ah'];
  int currentSelect = 0;
              ...
              decoration: BoxDecoration(
                border: Border(
                  ...
                  child: GestureDetector(
                    ...
                    onTap: (){
                      if (categoriesList[index]=="Guri Appartment ah"){
                        Navigator.push(context, MaterialPageRoute(builder: (builder)=>AppartMentPage()));
                      }else if(categoriesList[index]=="Guri Bacweyne ah"){

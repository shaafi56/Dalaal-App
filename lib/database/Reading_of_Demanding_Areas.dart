                              ...
                              child: ListTile(
                                title: Column(
                                  children: [
                                    ...
                                    SizedBox(height: 10,),
                                    Text('Current Address: ' + "${document['current_address']}"),
                                    SizedBox(height: 10,),
                                    Text('Address of Searching: ' + " ${document['Adress_of_searching']}"),
                                    SizedBox(height: 10,),
                                    Text('Sub Adress of searching: ' + "${document['Sub_Adress_of_searching']}"),
                                    SizedBox(height: 10,),
                                    Text('House type:' + "${document['house_type']}"),
                                    SizedBox(
                                      child: Divider(
                                        height: 20,
                                        color: Colors.white,
